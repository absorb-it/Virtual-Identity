...
function getIdentitiesArray(account) {
  var identities;
  if (Components.utils.import("resource:///modules/folderUtils.jsm") && Components.utils.import("resource:///modules/iteratorUtils.jsm") && typeof (toArray) == 'function' && typeof (fixIterator) == 'function') {
...
function getAccountsArray() {
  ...
  if (Components.utils.import("resource:///modules/folderUtils.jsm") && Components.utils.import("resource:///modules/iteratorUtils.jsm") && typeof (allAccountsSorted) == 'function') {
    ...
    accounts = accounts.filter(function isNonSuckyAccount(a) {
