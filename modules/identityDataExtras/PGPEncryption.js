...
identityDataExtrasObject_PGPEncryption.prototype = {
  ...
  getValueFromEnvironment_msgCompose: function () {
    if (this.enigmail_active && this.active) {
      this.value = (
        this._currentWindow.Enigmail.msg.statusEncrypted == this._currentWindow.EnigmailConstants.ENIG_FINAL_YES ||
        this._currentWindow.Enigmail.msg.statusEncrypted == this._currentWindow.EnigmailConstants.ENIG_FINAL_FORCEYES) ? "true" : "false";
    }
  }
}
