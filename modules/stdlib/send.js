...
function sendMessage(params, {
  ...
  fields.returnReceipt = ("returnReceipt" in params) ? params.returnReceipt : identity.requestReturnReceipt;
  fields.receiptHeaderType = ("receiptType" in params) ? params.receiptType : identity.receiptHeaderType;
  fields.DSN = ("requestDsn" in params) ? params.requestDsn : identity.requestDSN;
  ...
  references = ["<" + x + ">"
    for each([, x] in Iterator(references))
  ];
