...
function dateAsInMessageList(aDate) {
  ...
  let format = aDate.toLocaleDateString("%x") == (new Date()).toLocaleDateString("%x") ? Ci.nsIScriptableDateFormat.dateFormatNone : Ci.nsIScriptableDateFormat.dateFormatShort;
...
function combine(a1, a2) {
  ...
  return [
    [a1[i], a2[i]]
    for each(i in range(0, a1.length))
  ];
}